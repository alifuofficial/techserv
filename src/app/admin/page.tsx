    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative overflow-hidden">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              ...
              <div className="text-2xl font-bold text-slate-900">25,430</div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-emerald-500 text-xs font-bold flex items-center"><ArrowUpRight className="w-3 h-3 mr-0.5" /> 8.3%</span>
              <span className="text-[10px] text-slate-400">from last month</span>
            </div>
            <div className="w-24 h-8">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative overflow-hidden">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <div className="text-sm font-medium text-slate-500 mb-1">Entries Sold</div>
              <div className="text-2xl font-bold text-slate-900">125,680</div>
            </div>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-emerald-500 text-xs font-bold flex items-center"><ArrowUpRight className="w-3 h-3 mr-0.5" /> 23.7%</span>
              <span className="text-[10px] text-slate-400">from last month</span>
            </div>
            <div className="w-24 h-8">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative overflow-hidden">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              ...
              <div className="text-2xl font-bold text-slate-900">15,680,350 <span className="text-sm font-bold">ETB</span></div>
            </div>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <tbody className="text-sm">
                {topCampaigns.map((camp, i) => (
                  <tr key={i} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-4">
                      <div className="font-bold text-slate-700">{camp.sold} <span className="text-slate-400 font-normal">/ {camp.total}</span></div>
                    </td>
                    <td className="py-4 font-bold text-slate-700">{camp.rev}</td>
                    <td className="py-4 font-semibold text-slate-700">{camp.conv}</td>
                    <td className="py-4 text-center">
                      <span className={`px-2.5 py-1 text-[10px] font-bold rounded-full ${camp.statusColor}`}>
                        {camp.status}
                      </span>
                    </td>
