...
export default function RegisterClient({ telegramAuthOnly, botUsername }: { telegramAuthOnly: boolean, botUsername: string }) {
        ...
        <div className="relative z-10">
          ...
          {!telegramAuthOnly ? (
            ...
            <div className="py-8 text-center space-y-4">
              <p className="text-slate-300 mb-4">Registration is currently only available via Telegram.</p>
