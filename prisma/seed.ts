...
async function seed() {
  ...
  const botDevelopment = await db.service.upsert({
    ...
    create: {
      ...
      pricingTiers: JSON.stringify([
        { label: "Basic Bot", duration: "one_time", price: 199.99, description: "Simple bot with basic features", features: "Single function,Basic commands,Standard support,1 Week delivery" },
        { label: "Pro Bot", duration: "one_time", price: 499.99, popular: true, description: "Advanced bot with integrations", features: "Multiple functions,API integrations,Priority support,3 Days delivery,Database storage" },
        { label: "Enterprise Bot", duration: "one_time", price: 999.99, description: "Full custom solution with support", features: "Unlimited functions,Custom API,24/7 VIP support,Rush delivery,White-label solution,Scalable hosting" },
      ]),
      isActive: true,
      sortOrder: 2,
    },
  ...
  const webDevelopment = await db.service.upsert({
    ...
    create: {
      ...
      pricingType: "one_time",
      pricingTiers: JSON.stringify([
        { label: "Landing Page", duration: "one_time", price: 299.99, description: "Single-page responsive site", features: "One page,Modern design,Contact form,Basic SEO,Mobie optimized" },
        { label: "Business Website", duration: "one_time", price: 799.99, popular: true, description: "Multi-page business site", features: "Up to 5 pages,CMS included,Portfolio section,Advanced SEO,Google Maps,Social media links" },
        { label: "Web Application", duration: "one_time", price: 2499.99, description: "Full-stack web application", features: "Admin dashboard,User auth,Payment gateway,Custom API,Cloud hosting,Scalable architecture" },
      ]),
      isActive: true,
      sortOrder: 3,
    },
